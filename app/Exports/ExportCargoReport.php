...
class ExportCargoReport implements FromCollection, WithMapping, WithHeadings, WithColumnFormatting, WithEvents
{
    public $nomor = 0;
    protected $data;
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'F' => NumberFormat::FORMAT_TEXT, // Format teks
